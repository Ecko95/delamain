...
export function startDashboard(): void {
  ...
  const entry = join(dirname(fileURLToPath(import.meta.url)), "dashboard", "bunEntry.js");
  try {
...
export function bunMissingMessage(): string {
  return [
    ...
    "Install Bun from https://bun.sh/docs/installation, then rerun codex-peers --d or codex-peers dashboard.",
